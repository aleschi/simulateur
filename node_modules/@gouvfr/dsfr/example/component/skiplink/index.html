...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        ...
        <header role="banner" class="fr-header">
                ...
                <div class="fr-container">
                    <div class="fr-header__body-row">
                        <div class="fr-header__brand fr-enlarge-link">
                            <div class="fr-header__brand-top">
                                ...
                                <div class="fr-header__navbar">
                                    <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-647" id="button-648" title="Rechercher">
                                        Rechercher
                                    </button>
                                    <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-649" aria-haspopup="menu" id="button-650" title="Menu">
                                        Menu
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="fr-header__tools">
                            ...
                            <div class="fr-header__search fr-modal" id="modal-647">
            ...
            <div class="fr-header__menu fr-modal" id="modal-649" aria-labelledby="button-650">
                <div class="fr-container">
                    <button class="fr-btn--close fr-btn" aria-controls="modal-649" title="Fermer">
                        Fermer
                    </button>
                    ...
                    <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                        <ul class="fr-nav__list">
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-652">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-652">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-654" aria-current="true">Entrée menu active</button>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-655">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-655">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-mb-n3v">
                                                <button class="fr-btn--close fr-btn" aria-controls="mega-menu-655" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                                            <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-656">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-656">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-mb-n3v">
                                                <button class="fr-btn--close fr-btn" aria-controls="mega-menu-656" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                                            <div class="fr-col-12 fr-col-lg-3">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-657">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-657">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
