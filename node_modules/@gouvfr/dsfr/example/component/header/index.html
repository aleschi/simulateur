...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>En-tête - Design System</title>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/222789846/En-t+te+-+Header" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            ...
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                        ...
                        <div class="fr-container">
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-421" id="button-422" title="Rechercher">
                                                Rechercher
                                            </button>
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-423" aria-haspopup="menu" id="button-424" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-header__tools">
                                    ...
                                    <div class="fr-header__search fr-modal" id="modal-421">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button class="fr-btn--close fr-btn" aria-controls="modal-421" title="Fermer">
                                                Fermer
                                            </button>
                                            <div class="fr-search-bar" id="search-420" role="search">
                                                <label class="fr-label" for="search-420-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-420-input" name="search-420-input">
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-423" aria-labelledby="button-424">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-423" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-425" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-427">Entrée menu</button>
                                        <div class="fr-collapse fr-menu" id="menu-427">
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-428">Entrée mega menu</button>
                                        <div class="fr-collapse fr-mega-menu" id="mega-menu-428">
                                            <div class="fr-container fr-container--fluid fr-container-lg">
                                                <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                    <div class="fr-col-12 fr-mb-n3v">
                                                        <button class="fr-btn--close fr-btn" aria-controls="mega-menu-428" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-429" aria-current="true">Entrée menu active</button>
                                        <div class="fr-collapse fr-menu" id="menu-429">
                                            <ul class="fr-menu__list">
                                                <li>
                                                    <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                                </li>
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-430">Entrée mega menu</button>
                                        <div class="fr-collapse fr-mega-menu" id="mega-menu-430">
                                            <div class="fr-container fr-container--fluid fr-container-lg">
                                                <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                    <div class="fr-col-12 fr-mb-n3v">
                                                        <button class="fr-btn--close fr-btn" aria-controls="mega-menu-430" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                                    <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-431">Entrée mega menu</button>
                                        <div class="fr-collapse fr-mega-menu" id="mega-menu-431">
                                            <div class="fr-container fr-container--fluid fr-container-lg">
                                                <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                    <div class="fr-col-12 fr-mb-n3v">
                                                        <button class="fr-btn--close fr-btn" aria-controls="mega-menu-431" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                                    <div class="fr-col-12 fr-col-lg-3">
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-432">Entrée menu</button>
                                        <div class="fr-collapse fr-menu" id="menu-432">
                                            <ul class="fr-menu__list">
                                                <li>
                                                    <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                                </li>
                ...
                <div class="fr-container">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-446">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-446">
...
&lt;/header&gt;
            ...
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-447" aria-haspopup="menu" id="button-448" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-447" aria-labelledby="button-448">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-447" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-450" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self">accès direct</a>
                                    </li>
            ...
            <div class="fr-mb-12v">
                <div class="fr-container">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-455">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-455">
                            <pre class=" language-html"><code>&lt;header role="banner" class="fr-header"&gt;
    &lt;div class="fr-header__body"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-header__body-row"&gt;
...
&lt;/header&gt;
            ...
            <div class="fr-mb-12v">
                <div class="fr-container">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-456">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-456">
                            <pre class=" language-html"><code>&lt;header role="banner" class="fr-header"&gt;
    &lt;div class="fr-header__body"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-header__body-row"&gt;
...
&lt;/header&gt;
            ...
            <div class="fr-container">
                <h4 class="fr-h4">Header sans navigation avec raccourcis</h4>
            </div>
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                    <div class="fr-header__body">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-457" aria-haspopup="menu" id="button-458" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-457" aria-labelledby="button-458">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-457" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
...
&lt;/header&gt;
            ...
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-462" aria-haspopup="menu" id="button-463" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-462" aria-labelledby="button-463">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-462" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-465" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self">accès direct</a>
                                    </li>
...
&lt;/header&gt;
            ...
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-472" id="button-473" title="Rechercher">
                                                Rechercher
                                            </button>
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-474" aria-haspopup="menu" id="button-475" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-header__tools">
                                    <div class="fr-header__search fr-modal" id="modal-472">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button class="fr-btn--close fr-btn" aria-controls="modal-472" title="Fermer">
                                                Fermer
                                            </button>
                                            <div class="fr-search-bar" id="search-471" role="search">
                                                <label class="fr-label" for="search-471-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-471-input" name="search-471-input">
                                                <button class="fr-btn" title="Rechercher">
                                                    Rechercher
                                                </button>
                                            </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-474" aria-labelledby="button-475">
                        <div class="fr-container">
...
&lt;/header&gt;
            ...
            <div class="fr-container">
                <h4 class="fr-h4">Header avec opérateur vertical, recherche</h4>
            </div>
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                    <div class="fr-header__body">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-489" id="button-490" title="Rechercher">
                                                Rechercher
                                            </button>
                                ...
                                <div class="fr-header__tools">
                                    <div class="fr-header__search fr-modal" id="modal-489">
                                        <div class="fr-container fr-container-lg--fluid">
                                            ...
                                            <div class="fr-search-bar" id="search-488" role="search">
                                                ...
                                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-488-input" name="search-488-input">
                                                <button class="fr-btn" title="Rechercher">
                                                    Rechercher
                                                </button>
                                            </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-491" aria-labelledby="button-492">
                        <div class="fr-container">
                            ...
                            <nav class="fr-nav" id="navigation-495" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self">accès direct</a>
                                    </li>
...
&lt;/header&gt;
            ...
            <div class="fr-container">
                <h4 class="fr-h4">Header avec opérateur horizontal, nom de service, lien d’accès, recherche</h4>
            </div>
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                    <div class="fr-header__body">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-506" id="button-507" title="Rechercher">
                                                Rechercher
                                            </button>
                                            <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-508" aria-haspopup="menu" id="button-509" title="Menu">
                                                Menu
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-header__tools">
                                    ...
                                    <div class="fr-header__search fr-modal" id="modal-506">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button class="fr-btn--close fr-btn" aria-controls="modal-506" title="Fermer">
                                                Fermer
                                            </button>
                                            <div class="fr-search-bar" id="search-505" role="search">
                                                <label class="fr-label" for="search-505-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-505-input" name="search-505-input">
                                                <button class="fr-btn" title="Rechercher">
                                                    Rechercher
                                                </button>
                                            </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-508" aria-labelledby="button-509">
                        <div class="fr-container">
                            <button class="fr-btn--close fr-btn" aria-controls="modal-508" title="Fermer">
                                Fermer
                            </button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-512" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <a class="fr-nav__link" href="#" target="_self">accès direct</a>
                                    </li>
            ...
            <div class="fr-mb-6v">
                <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__body-row">
                                <div class="fr-header__brand fr-enlarge-link">
                                    <div class="fr-header__brand-top">
                                        ...
                                        <div class="fr-header__navbar">
                                            <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-528" id="button-529" title="Rechercher">
                                                Rechercher
                                            </button>
                                ...
                                <div class="fr-header__tools">
                                    ...
                                    <div class="fr-header__search fr-modal" id="modal-528">
                                        <div class="fr-container fr-container-lg--fluid">
                                            <button class="fr-link--close fr-link" aria-controls="modal-528">Fermer</button>
                                            <div class="fr-search-bar" id="search-527" role="search">
                                                <label class="fr-label" for="search-527-input">
                                                    Rechercher
                                                </label>
                                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-527-input" name="search-527-input">
                                                <button class="fr-btn" title="Rechercher">
                                                    Rechercher
                                                </button>
                                            </div>
                    ...
                    <div class="fr-header__menu fr-modal" id="modal-530" aria-labelledby="button-531">
                        <div class="fr-container">
                            <button class="fr-link--close fr-link" aria-controls="modal-530">Fermer</button>
                            <div class="fr-header__menu-links">
                            </div>
                            <nav class="fr-nav" id="navigation-532" role="navigation" aria-label="Menu principal">
                                <ul class="fr-nav__list">
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-534">Entrée menu</button>
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-535">Entrée mega menu</button>
                                        <div class="fr-collapse fr-mega-menu" id="mega-menu-535">
                                            <div class="fr-container fr-container--fluid fr-container-lg">
                                                <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                    <div class="fr-col-12 fr-mb-n3v">
                                                        <button class="fr-btn--close fr-btn" aria-controls="mega-menu-535" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                                    <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-536" aria-current="true">Entrée menu active</button>
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-538">Entrée mega menu</button>
                                        <div class="fr-collapse fr-mega-menu" id="mega-menu-538">
                                            <div class="fr-container fr-container--fluid fr-container-lg">
                                                <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                    <div class="fr-col-12 fr-mb-n3v">
                                                        <button class="fr-btn--close fr-btn" aria-controls="mega-menu-538" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                                    <div class="fr-col-12 fr-col-lg-3">
                                    ...
                                    <li class="fr-nav__item">
                                        <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-539">Entrée menu</button>
                                        <div class="fr-collapse fr-menu" id="menu-539">
                                            <ul class="fr-menu__list">
                                                <li>
                                                    <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                                </li>
