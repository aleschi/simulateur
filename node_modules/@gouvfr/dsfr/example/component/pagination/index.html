...
&lt;/nav&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1020">Extrait de code</button>
                        </h3>
...
&lt;/nav&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1021">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1021">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
...
&lt;/nav&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1022">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1022">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
