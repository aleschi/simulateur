    ...
    <body id="top" class="fr-mb-12w">
        ...
        <div class="fr-mb-12w">
            <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__brand fr-enlarge-link">
                                <div class="fr-header__brand-top">
                                    ...
                                    <div class="fr-header__navbar">
                                        <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-1024" aria-haspopup="menu" id="button-1025" title="Menu">
                                            Menu
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="fr-header__menu fr-modal" id="modal-1024" aria-labelledby="button-1025">
                    <div class="fr-container">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-1024" title="Fermer">
                            Fermer
                        </button>
                        ...
                        <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1026">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1026">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1028" aria-current="true">Entrée menu active</button>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1029">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1029">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1029" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1030">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1030">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1030" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-3">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1031">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1031">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1032">Extrait de code</button>
                        </h3>
...
&lt;/button&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1033">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1033">
...
&lt;/dialog&gt;
            ...
            <footer class="fr-footer" role="contentinfo" id="footer-1023">
                <div class="fr-container">
            ...
            <header role="banner" class="fr-header">
                        ...
                        <div class="fr-header__body-row">
                            <div class="fr-header__brand fr-enlarge-link">
                                <div class="fr-header__brand-top">
                                    ...
                                    <div class="fr-header__navbar">
                                        <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-1035" aria-haspopup="menu" id="button-1036" title="Menu">
                                            Menu
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="fr-header__menu fr-modal" id="modal-1035" aria-labelledby="button-1036">
                    <div class="fr-container">
                        <button class="fr-link--close fr-link" aria-controls="modal-1035">Fermer</button>
                        <div class="fr-header__menu-links">
                        </div>
                        <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1037">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1037">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1039" aria-current="true">Entrée menu active</button>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1040">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1040">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1040" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1041">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1041">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1041" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-3">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1042">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1042">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
...
&lt;/dialog&gt;
            ...
            <footer class="fr-footer" role="contentinfo" id="footer-1034">
                <div class="fr-container">
                    <div class="fr-footer__body">
                        <div class="fr-footer__brand fr-enlarge-link">
                            <a href="/" title="Retour à l’accueil">
